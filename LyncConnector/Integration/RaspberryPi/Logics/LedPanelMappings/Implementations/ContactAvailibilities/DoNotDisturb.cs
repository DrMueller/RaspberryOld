...
{
    internal class DoNotDisturb : LedPanelMapper
    {
        ...
        internal override VisualLedPanel CreateLedPanel()
        {
            ...
            result[0, 0].VisualColor = Colors.White.ToVisualLedColor();
            result[1, 0].VisualColor = Colors.White.ToVisualLedColor();
            ...
            result[6, 0].VisualColor = Colors.White.ToVisualLedColor();
            result[7, 0].VisualColor = Colors.White.ToVisualLedColor();
            result[0, 1].VisualColor = Colors.White.ToVisualLedColor();
            result[1, 1].VisualColor = Colors.Red.ToVisualLedColor();
            result[2, 1].VisualColor = Colors.Red.ToVisualLedColor();
            result[3, 1].VisualColor = Colors.Red.ToVisualLedColor();
            result[4, 1].VisualColor = Colors.Red.ToVisualLedColor();
            ...
            result[3, 2].VisualColor = Colors.Red.ToVisualLedColor();
            result[4, 2].VisualColor = Colors.Red.ToVisualLedColor();
            ...
            result[2, 3].VisualColor = Colors.White.ToVisualLedColor();
            result[3, 3].VisualColor = Colors.White.ToVisualLedColor();
            result[4, 3].VisualColor = Colors.White.ToVisualLedColor();
            ...
            result[6, 4].VisualColor = Colors.White.ToVisualLedColor();
            ...
            result[0, 6].VisualColor = Colors.White.ToVisualLedColor();
            result[1, 6].VisualColor = Colors.Red.ToVisualLedColor();
            result[2, 6].VisualColor = Colors.Red.ToVisualLedColor();
            result[3, 6].VisualColor = Colors.Red.ToVisualLedColor();
            result[4, 6].VisualColor = Colors.Red.ToVisualLedColor();
            result[5, 6].VisualColor = Colors.Red.ToVisualLedColor();
            result[6, 6].VisualColor = Colors.Red.ToVisualLedColor();
            result[7, 6].VisualColor = Colors.White.ToVisualLedColor();
            result[0, 7].VisualColor = Colors.White.ToVisualLedColor();
            result[1, 7].VisualColor = Colors.White.ToVisualLedColor();
            ...
            result[6, 7].VisualColor = Colors.White.ToVisualLedColor();
            result[7, 7].VisualColor = Colors.White.ToVisualLedColor();
            return result;
        }

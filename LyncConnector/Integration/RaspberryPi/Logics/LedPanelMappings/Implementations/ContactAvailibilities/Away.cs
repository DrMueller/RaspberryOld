...
{
    internal class Away : LedPanelMapper
    {
        ...
        internal override VisualLedPanel CreateLedPanel()
        {
            ...
            result[1, 1].VisualColor = Colors.Yellow.ToVisualLedColor();
            result[2, 1].VisualColor = Colors.Yellow.ToVisualLedColor();
            result[3, 1].VisualColor = Colors.Red.ToVisualLedColor();
            result[4, 1].VisualColor = Colors.Red.ToVisualLedColor();
            result[5, 1].VisualColor = Colors.Yellow.ToVisualLedColor();
            ...
            result[1, 2].VisualColor = Colors.Yellow.ToVisualLedColor();
            ...
            result[6, 2].VisualColor = Colors.Yellow.ToVisualLedColor();
            result[7, 2].VisualColor = Colors.Yellow.ToVisualLedColor();
            result[0, 3].VisualColor = Colors.Yellow.ToVisualLedColor();
            result[1, 3].VisualColor = Colors.Yellow.ToVisualLedColor();
            ...
            result[6, 3].VisualColor = Colors.Yellow.ToVisualLedColor();
            ...
            result[3, 4].VisualColor = Colors.Red.ToVisualLedColor();
            result[4, 4].VisualColor = Colors.Red.ToVisualLedColor();
            ...
            result[5, 5].VisualColor = Colors.Yellow.ToVisualLedColor();
